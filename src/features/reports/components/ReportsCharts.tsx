 ...
 * ReportsCharts
 *
 * Displays the report archive grid, scheduled jobs panel,
 * and aggregate statistics row.
 */
const ReportsCharts: React.FC<ReportsChartsProps> = ({ documents, scheduledJobs, stats }) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 mt-3">
              <span className="text-xs text-slate-500 font-mono bg-background-dark px-1.5 py-0.5 rounded border border-border-dark">
                {doc.size}
              </span>
    ...
    {stats && (
      <div className="mt-4 grid grid-cols-3 gap-4 border-t border-border-dark pt-6">
        ...
        <div className="text-center border-l border-border-dark">
          <p className="text-2xl font-bold text-white">{stats.archiveSize}</p>
